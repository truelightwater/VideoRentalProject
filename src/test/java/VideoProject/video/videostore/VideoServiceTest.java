...
public class VideoServiceTest {
    ...
    void joinVideo() {
        ...
        Video findVideo = videoRepository.findByVideo(1L);

        // then
        assertThat(video1).isNotSameAs(video2);
        assertThat(video2).isEqualTo(video2);
    ...
    void findOneVideo() {
        ...
        // then
        assertThat(video3).isNotSameAs(video4);
    }
